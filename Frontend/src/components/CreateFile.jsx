                ...
                <Form onSubmit={this.handleSubmit.bind(this)}>
                    <FormGroup>
                        ...
                        <Row>
                            ...
                            <Col>
                                <b>Publicador</b>
                                <Input type="text" placeholder="Publicador" name="publicador" onChange={this.handleInput.bind(this)} value="CIBioFi-GISMODEL" />
                            </Col>
                            <Col>
                                <b>Derechos</b>
                                <Input type="text" placeholder="Derechos" name="derechos" onChange={this.handleInput.bind(this)} />
                            </Col>
                        </Row>
                        <Row>
                            <Col>
                        ...
                        <Row>
                            <Col>
                                <b>Lote</b>
                                <Input type="text" placeholder="Lote" name="lote" onChange={this.handleInput.bind(this)} />
                            </Col>
                            <Col>
                                <b>Fase</b>
                                <Input type="number" placeholder="Fase" name="fase" onChange={this.handleInput.bind(this)} />
                            </Col>
                        </Row>
                        <Row>
                            <Col>
                            ...
                            <Col>
                                <b>Estado:</b> <Button
                                    color={this.state.publico ? "success" : "danger"} onClick={() => this.setState({ publico: !this.state.publico })}>
