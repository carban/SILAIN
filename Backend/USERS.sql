...
create table descargas(id SERIAL PRIMARY KEY, id_usuario SERIAL, id_metadato INTEGER, proposito VARCHAR(200), fecha DATE, hora TIME, FOREIGN KEY(id_usuario) REFERENCES usuario(id), FOREIGN KEY(id_metadato) REFERENCES metadato(idmetadato));
